    ...
    <>
      <div className="proj_container_section" style={{marginBottom: '30px', display: 'flex'}}>
        ...
        <div className="proj_right">
          <img src={myproject} alt="Project Img"  style={{backgroundRepeat: "no-repeat", display: "flex", justifyContent: "center", height: "400px", width: "400px", border: "1px solid black", borderRadius: "8px", backgroundSize: "cover", backgroundPosition: "center", marginRight: '50px', marginTop: '40px', marginLeft: '40px',}} />
        </div>
      </div>
    </>
 )
